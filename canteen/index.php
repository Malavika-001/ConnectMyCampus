...
$pageTitle = 'Home';
include 'header.php';
include 'authentication.php'; // ✅ Include your auth system here

// Optional: if you want to restrict index access to logged-in users only
// requireAuth(); 
?>
...
<style>
    ...
    .module-section { margin-top: 3rem; margin-bottom: 3rem; }
    .card-title { color: #111; }
    .card-text { color: #555; }
    ul li::marker { color: #007bff; }
    .divider { border-top: 1px solid #ddd; margin: 3rem 0; }
    .hours-box {
        max-width: 360px;
        background-color: #ffffff;
        border: 1px solid #e4e9f0;
...
<main class="container text-center">
    ...
    <!-- Show Operating Hours for regular users -->
                ...
                <div class="col-md-5">
                    <a href="general_menu.php">
                        <div class="card p-4 h-100">
                            ...
                            <p class="card-text">Explore the weekly menu and pricing.</p>
                        </div>
                    </a>
                </div>
                <div class="col-md-5">
                    <a href="todays_menu.php">
                        <div class="card p-4 h-100">
                            ...
                            <p class="card-text">See what's fresh and special today!</p>
                        </div>
                    </a>
                </div>
            </div>
                ...
                <div class="col-md-5">
                    <a href="prebooking.php">
                        <div class="card p-4 h-100">
                            ...
                            <p class="card-text">Reserve meals and skip the line.</p>
                        </div>
                    </a>
                </div>
                <div class="col-md-5">
                    <a href="reports.php">
                        <div class="card p-4 h-100">
                            ...
                            <p class="card-text">Send feedback or report any issue.</p>
                        </div>
                    </a>
                </div>
            </div>
    ...
    <?php elseif (isLoggedIn() && isAdmin()): ?>
        ...
        <section class="module-section">
            <div class="row justify-content-center g-4 mb-4">
                <div class="col-md-5">
                    <a href="general_menu.php?action=admin">
                        <div class="card p-4 h-100">
                            <i class="fas fa-cogs icon-lg text-primary"></i>
                            <h5 class="card-title">Manage Menu</h5>
                            <p class="card-text">Add, edit, or remove general menu items.</p>
                        </div>
                    </a>
                </div>
                <div class="col-md-5">
                    <a href="todays_menu.php?action=admin">
                        <div class="card p-4 h-100">
                            <i class="fas fa-calendar-check icon-lg text-success"></i>
                            <h5 class="card-title">Set Today's Menu</h5>
                            <p class="card-text">Update today’s food list and prices.</p>
                        </div>
                    </a>
                </div>
            </div>
                ...
                <div class="col-md-5">
                    <a href="admin_orders.php">
                        <div class="card p-4 h-100">
                            ...
                            <p class="card-text">See prebooked and ongoing orders.</p>
                        </div>
                    </a>
                </div>
                <div class="col-md-5">
                    <a href="admin_report.php">
                        <div class="card p-4 h-100">
                            ...
                            <h5 class="card-title">Handle Reports</h5>
                            <p class="card-text">Review feedback and resolve user issues.</p>
                        </div>
                    </a>
                </div>
            </div>
    ...
    <?php else: ?>
        <div class="alert alert-warning mt-5" role="alert">
            Please <a href="login.php" class="alert-link">log in</a> to access your canteen dashboard.
        </div>
    <?php endif; ?>
    ...
    <section class="mt-5 text-start mx-auto" style="max-width: 900px;">
        <div class="about-box">
            ...
            <p>The <strong>College Canteen Service</strong> simplifies your daily food experience.
                You can check menus, prebook meals, and send feedback — all in one place.</p>
            <ul>
                <li><strong>Live Menus</strong>: View daily and weekly food items with ease.</li>
                <li><strong>Prebooking</strong>: Plan ahead and skip the line.</li>
